...
# Create .streamlit/secrets.toml and add your keys (see above)
...
- **Never commit real API keys** to GitHub. Always use Streamlit Secrets for deployment.
- Add `.streamlit/secrets.toml` to your `.gitignore` if running locally with real keys.
